...
function setHaveObtainableItem(element){
    element.style.backgroundColor = "rgb(20 191 33)";
...
function loadWeapons(){
    ...
    loadClickableIdOptions(
        "image_gallery_weapon", "image_gallery_weapon", "player_weapon", validInfos.length, 17, 
        idx => {
...
$(document).ready(async () => {
    await Promise.all([
        (async () => { langEUen = await fetchJson("https://raw.githubusercontent.com/BoxBoy12t/savedittestS3.github.io/main/assets/lang/EUen.json") })(),
